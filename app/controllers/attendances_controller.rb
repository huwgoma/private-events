class AttendancesController < ApplicationController
  ...
  def create
    @attendance = AttendancesCreator.call(attendee_id: current_user.id, event_id: params[:event_id])
  ...
  def destroy
    current_user.attendances.find_by(event_id: params[:event_id]).destroy
